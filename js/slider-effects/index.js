import { effectLevelSliderParent, effectLevelSlider, effectLevelInput, effectChecked, uploadPreviewImage } from './slider-variables';
import { EFFECTS, DEFAULT_MIN, DEFAULT_MAX, DEFAULT_START } from './effect-data';

const sliderVisableToggle = (isShown = true) => {
	effectLevelSliderParent.classList.toggle('hidden', isShown);
};
